...
const threeOfKind = new SumDistro({
  count: 3,
  description: "Total of all dice if 3 are the same",
});
const fourOfKind = new SumDistro({
  count: 4,
  description: "Total of all dice if 4 are the same",
});
...
const smallStraight = new SmallStraight({
  score: 30,
  description: "30 points for a run of 4",
});
const largeStraight = new LargeStraight({
  score: 40,
  description: "40 points for a run of 5",
});
